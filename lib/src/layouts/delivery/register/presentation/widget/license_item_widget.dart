...
class LicenseItemWidget extends StatefulWidget {
  ...
  @override
  State<LicenseItemWidget> createState() => _LicenseItemWidgetState();
}

class _LicenseItemWidgetState extends State<LicenseItemWidget> {
  File? file;
  @override
  Widget build(BuildContext context) {
    return Expanded(
      child: ValidatorField<File>(
          validator: (value) {
            if (value == null) {
